...
class MeanReversionStrategy(BaseStrategy):
    ...
    async def analyze(
        ...
        **kwargs
        ...
        if cache:
            upper, middle, lower = cache.bollinger_bands(self.bb_period, self.bb_std)
            bb_pos = cache.bb_position(self.bb_period, self.bb_std)
        ...
        # Fee-aware stop loss and take profit (sl 2.25 to reduce chop stops)
