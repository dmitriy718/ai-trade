...
class TradePredictorFeatures:
    ...
    def extract(self, market_state: Dict[str, Any]) -> np.ndarray:
        ...
        for i, name in enumerate(self.FEATURE_NAMES):
            raw_value = float(market_state.get(name, 0.0))
            features[i] = self._normalize_feature(name, raw_value)
...
class TFLitePredictor:
    ...
    def __init__(self, model_path: str = "models/trade_predictor.tflite"):
        ...
        self.features = TradePredictorFeatures()
    ...
    def get_model_info(self) -> Dict[str, Any]:
        ...
        info = {
            ...
            "features": TradePredictorFeatures.FEATURE_NAMES,
        }
